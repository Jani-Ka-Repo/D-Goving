...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("OraMusic/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((447, 447))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('OraMusic/assets/font.ttf', size=40)
    welcome_font = ImageFont.truetype('OraMusic/assets/font.ttf', size=60)
