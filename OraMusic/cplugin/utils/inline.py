...
buttons = InlineKeyboardMarkup(
    [
        ...
        [
            styled_button(text=" ✦ 𝐂ʟᴏηє 𝐌є ✦ ", url="https://t.me/Oramusicbot", style=ButtonStyle.SUCCESS)
        ],
    ]
)
...
close_key = InlineKeyboardMarkup(
    [
        [
            styled_button(text=" 𝐀ᴅᴅ 𝐌є 𝐁ᴀʙʏ ", url="https://t.me/Oramusicbot?startgroup=true", style=ButtonStyle.SUCCESS),
