...
from OraMusic.utils.inline.play import stream_markup, telegram_markup
...
class Call(PyTgCalls):
    ...
    async def change_stream(self, client, chat_id):
        ...
        try:
            ...
            if not check:
                from OraMusic.utils.database.autoplay import is_autoplay_group
                ...
                if auto_on and popped:
                    ...
                    try:
                        ...
                        if valid_choices:
                            ...
                            success = True
                            try:
                                from OraMusic.utils.logger import autoplay_log
